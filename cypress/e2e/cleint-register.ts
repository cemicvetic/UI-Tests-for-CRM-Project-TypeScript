...
describe('Client creation', () => {
    ...
    describe('SMOKE', () => {
        ...
        it('Client creation if all fields are filled', () => {
            ...
            // Uncomment the below code if you decide to include 'description' in your checks
            // Dashboard.tableContent.find('td').eq(7).invoke('text').then((text: string) => {
            //     expect(text).to.eq(client.description);
            // });
        });
    });
